    ...
    <div className="p-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {displayedCourses.map(course => (
          ...
          >
            <img src={courseImage} alt={course.title} className="w-full h-100 object-cover opacity-80 group-hover:opacity-50 transition-opacity duration-300" />
      ...
      {!showMore && (
        <div className="text-center mt-8">
          <button 
            ...
            className="text-lg font-semibold text-white bg-orange-500 rounded-lg px-6 py-3 hover:bg-orange-600"
          >
            View more
          </button>
        </div>
